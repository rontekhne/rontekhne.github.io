function showIndexPosts()
{
    ...
    <section>
        <article>
            <h2>DICIONÁRIO TUPIX</h2>
            <p>
                O tupi antigo foi a língua falada pelos indígenas 
                e pelos colonizadores nos séculos XVI e XVII por 
                toda a costa do Brasil. Em breve lançarei um 
                dicionário Tupi Antigo - Português para Android.
            </p>
            <a class="read" href="/post/22-12-2023_tupix.html">LER</a>
        </article>
        <article>
            <h2>ARX ARCADE 2D</h2>
            <p> 
